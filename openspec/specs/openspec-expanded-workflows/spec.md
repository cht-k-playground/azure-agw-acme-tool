# openspec-expanded-workflows

> Purpose: Defines the behaviour of the Expanded Mode OpenSpec slash commands available in this project via `.kilocode/workflows/` and `.kilocode/skills/`.
